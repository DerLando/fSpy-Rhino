...
namespace fSpy_Rhino
{
    ...
    ///</summary>
    public class fSpyRhinoPlugIn : Rhino.PlugIns.FileImportPlugIn

    {
        public fSpyRhinoPlugIn()
        {
            Instance = this;
        }

        ///<summary>Gets the only instance of the fSpyRhinoPlugIn plug-in.</summary>
        public static fSpyRhinoPlugIn Instance
        {
            get; private set;
        }
        ...
        /// <summary>
        /// Is called when a user requests to import a ."fspy file.
